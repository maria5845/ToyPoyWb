...
<section id="container" class="container">
  ...
  <main>
    <h3>약관동의</h3>
    <div class="agreement_wrap01">
      <input type="checkbox" id="agree_a">
      <label for="agree_a"><strong>(필수)</strong> 이용약관</label> <a href="#" class="view_all">전체보기</a>
      <p class="agreement_box">
        제1조(목적)<br>
        <br>
        표준약관 제10023호<br>
        <br>
        이 약관은 (주)NORAN 회사(전자거래 사업자)가 운영하는 NORAN 사이버 몰(이하 "몰"이라 한다)에서 제공하는 인터넷 관련 서비스(이하 "서비스"라 한다)를 이용함에 있어 사이버몰과 이용자의 권리·의무 및 책임사항을 규정함을 목적으로 합니다.<br>
        ※ 「PC통신등을 이용하는 전자거래에 대해서도 그 성질에 반하지 않는한 이 약관을 준용합니다」<br>
        <br>
        <br>
        제2조(정의)<br>
        <br>
        ① "몰"이란 (주)NORAN 회사가 재화 또는 용역을 이용자에게 제공하기 위하여 컴퓨터등 정보통신설비를 이용하여 재화 또는 용역을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.<br>
    ...
    <div class="agreement_wrap02">
      <input type="checkbox" id="agree_b">
      <label for="agree_b"><strong>(필수)</strong> 개인정보 수집 및 이용</label> <a href="#" class="view_all">전체보기</a>
